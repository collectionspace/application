...
public class UserUISpec implements WebMethod {
	private Record record;

	public UserUISpec(Record record) {
		this.record=record;
	}
	...
	private JSONObject uispec(UIRequest request,String suffix) throws UIException {
		try {
			JSONObject out=new JSONObject();
			//out.put("userList",generateListSection());
			out.put("userDetails",generateDataEntrySection());
			return out;
