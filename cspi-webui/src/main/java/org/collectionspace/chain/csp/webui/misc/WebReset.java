		...
		try {
			...
			if(!path.equals("nodelete")){
				...
				for(String dir : paths) {
					...
					if("rolePermission".equals(dir) || "accountrole".equals(dir)  || "permrole".equals(dir) || "permission".equals(dir) || "role".equals(dir)|| "userrole".equals(dir) || "users".equals(dir) || "location".equals(dir) ){
						continue;
					}
