...
public abstract class SchemaStructure {
	...
	/**
	 * Abstract out the initialization process so we can just call it from both
	 * the constructors
	 * 
	 * @param spec
	 * @param sview
	 ...
	 * @throws JSONException
	 */
	protected void actualGroupEntry(FieldSet fs, JSONObject out, UISpecRunContext context, JSONObject contents)
			throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualFieldExpanderEntry(JSONObject out, FieldSet fs, UISpecRunContext context)
			throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualChooserField(JSONObject out, FieldSet fs, UISpecRunContext context, Boolean useContainer)
			throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualWorkflowStateField(JSONObject out, FieldSet fs, UISpecRunContext context)
			throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualFieldNotRefactored(JSONObject out, FieldSet fs, UISpecRunContext context)
			throws JSONException {
		// Single field
		actualField(out, fs, context);
	 ...
	 * @param context
	 *            Information about the kind of spec we are producing.
	 * @param decorators
	 *            the decorators array object, if we have to handle multiple ui
	 *            behaviors.
	 * @return
	 * @throws JSONException
	 */
	protected Object actualFieldEntry(FieldSet fs, UISpecRunContext context, JSONArray decorators)
			throws JSONException {
		Field f = (Field) fs;
		if ("plain".equals(f.getUIType())) {
			...
			if (this.spectype.equals("search") && f.getSearchType().equals("range") && isAStructureDate(f)) {
				return displayAsplain(f, context);
			} else {
	...
	/**
	 * Default behaviour if don't know what the field is test data type and then
	 * just assume a string
	 * 
	 * @param fs
	 * @param context
	 * @return
	...
	protected Object makeAOtherField(Field fs, UISpecRunContext context) throws JSONException {
		...
		if (datatype.equals("boolean")) {
			return actualBooleanField(fs, context);
		}
	 ...
	 * @throws JSONException
	 */
	protected void actualStructuredDate(FieldSet fs, JSONObject out, UISpecRunContext sub, JSONObject subexpander,
			Record subitems, JSONObject options) throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualSubRecordField(JSONObject out, FieldSet fs, UISpecRunContext context, Record subr,
			Boolean repeated, JSONObject parent) throws JSONException {
	 ...
	 * @throws JSONException
	 */
	protected void actualRepeatNonSiblingEntry(JSONObject out, Repeat r, UISpecRunContext context, JSONObject contents)
			throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void makeASubRecordEntry(JSONObject out, FieldSet fs, UISpecRunContext context, JSONObject outerlayer)
			throws JSONException {
	 ...
	 * @throws JSONException
	 */
	protected void makeASubRecord(Record subr, JSONObject out, Boolean repeated, UISpecRunContext context,
	 ...
	 * @throws JSONException
	 */
	protected void makeAStructureDate(FieldSet fs, JSONObject out, JSONObject subexpander, JSONObject options,
			Record subitems, UISpecRunContext sub, UISpecRunContext mainContext) throws JSONException {
	 ...
	 * @throws JSONException
	 */
	protected void makeAOtherGroup(FieldSet fs, JSONObject out, JSONObject subexpander, JSONObject options,
	 ...
	 * @throws JSONException
	 */
	protected void makeASelfRenderer(FieldSet fs, UISpecRunContext context, JSONObject out, JSONObject subexpander,
			JSONObject options, Record subitems, UISpecRunContext sub) throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualOtherGroup(FieldSet fs, JSONObject out, UISpecRunContext sub, Record subitems)
			throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualAddDecorator(FieldSet fs, JSONObject out, UISpecRunContext sub, JSONObject options)
			throws JSONException {
	}
	 ...
	 * @throws JSONException
	 */
	protected void actualSelfRenderer(FieldSet fs, UISpecRunContext context, JSONObject subexpander, Record subitems)
			throws JSONException {
	...
	/**
	 * when there is a mismatch between what the UI and services think are
	 * repeatables
	 * 
	 * @param r
	 * @return
	...
	/**
	 * Test whether this is a ghost of a repeat because of the advance search
	 * quirkiness
	 * 
	 * @param fs
	 * @return
	...
	/**
	 * test whether this is field should be included e.g. if this is adv search
	 * and this field isn't one then ignore
	 * 
	 * @param fs
	 * @return
	 */
	...
	/**
	 * Check if fieldSet is a subrecord surrounded by a Group tag but not a
	 * repeat tag repeats are done separately as they need more nesting
	 * 
	 * @param fs
	 * @return
	 */
	...
	/**
	 * groupfields are used by structured dates which are being a little
	 * different
	 * 
	 * @param fs
	 * @return
	...
	/**
	 * Check if the UI has refactored this as one item or wether it is multiple
	 * containers
	 * 
	 * @param fs
	 * @return
