...
public class WebUI implements CSP, UI, Configurable {
	...
	private void configure_finish(Spec spec) {
		...
		addMethod(Operation.CREATE,new String[]{"uploads"},0,new BlobCreateUpdate(this,spec));
		addMethod(Operation.READ,new String[]{"uploads"},0,new BlobCreateUpdate(this,spec));
